					...
					{ (onClose) => (
						<>
							...
							<ModalFooter>
								...
								{ showDescription ? <Button onPress={ onClose } color='primary' radius='sm' size='lg' className='w-max px-5 uppercase font-bold'>
									{ t('close') }
								</Button> : <Button onPress={ handleClick } color='primary' radius='sm' size='lg' className='w-max px-5 uppercase font-bold'>
									{ t('calculate') }
								</Button> }
							</ModalFooter>
						</>
